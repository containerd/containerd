...
func TestCRIImagePullTimeout(t *testing.T) {
	...
	t.Run("HoldingContentOpenWriter", testCRIImagePullTimeoutByHoldingContentOpenWriterWithLocal)
	t.Run("HoldingContentOpenWriterUsingTransfer", testCRIImagePullTimeoutByHoldingContentOpenWriterWithTransfer)
	t.Run("NoDataTransferred", testCRIImagePullTimeoutByNoDataTransferredWithLocal)
	t.Run("NoDataTransferredUsingTransfer", testCRIImagePullTimeoutByNoDataTransferredWithTransfer)
	t.Run("SlowCommitWriter", testCRIImagePullTimeoutBySlowCommitWriterWithLocal)
	t.Run("SlowCommitWriterUsingTransfer", testCRIImagePullTimeoutBySlowCommitWriterWithTransfer)
}
