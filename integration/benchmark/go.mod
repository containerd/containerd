module github.com/containerd/containerd/integration/benchmark

go 1.18

require github.com/containerd/containerd v1.6.1

require github.com/opencontainers/image-spec v1.0.3-0.20220303224323-02efb9a75ee1 // indirect
