...
func TestPrivilegedDevices(t *testing.T) {
	...
	for desc, test := range map[string]struct {
		...
		"expect host devices and all device whitelist when privileged is true": {
			privileged:                   true,
			privilegedWithoutHostDevices: false,
			privilegedWithoutHostDevicesAllDevicesAllowed: false,
		...
		"expect host devices and all devices whitelist when privileged is true and privilegedWithoutHostDevices is true and privilegedWithoutHostDevicesAllDevicesAllowed is true": {
			privileged:                   true,
			privilegedWithoutHostDevices: true,
