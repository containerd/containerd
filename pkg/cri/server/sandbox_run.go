...
func (c *criService) RunPodSandbox(ctx context.Context, r *runtime.RunPodSandboxRequest) (_ *runtime.RunPodSandboxResponse, retErr error) {
	...
	sandboxInfo.Address = ctrl.Address
	// Save sandbox address to store
	if sandboxInfo, err = c.client.SandboxStore().Update(ctx, sandboxInfo, "address"); err != nil {
		return nil, fmt.Errorf("unable to update address for sandbox %q: %w", id, err)
	}
