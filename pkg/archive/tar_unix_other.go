...
// openParentFlags opens the parent directory handle used by lchmod. darwin is
// the only one of these platforms that builds this package, and x/sys/unix has
// no search-only open flag (O_PATH or O_SEARCH) for it, so like os.Root this
