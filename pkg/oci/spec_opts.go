...
func withReadonlyFS(ctx context.Context, client Client, mounts []mount.Mount, fn func(root string) error) error {
	...
	return mount.WithReadonlyTempMount(ctx, mounts, fn)
}
