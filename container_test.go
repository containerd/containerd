...
import (
	...
	runhcstypes "github.com/Microsoft/hcsshim/cmd/containerd-shim-runhcs-v1/options"
...
func TestNewContainer(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSpec())
	if err != nil {
		t.Fatal(err)
	}
...
func TestContainerStart(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSnapshot(id, image), WithNewSpec(oci.WithImageConfig(image), withExitStatus(7)))
	if err != nil {
		t.Fatal(err)
	}
...
func TestContainerOutput(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSnapshot(id, image), WithNewSpec(oci.WithImageConfig(image), withProcessArgs("echo", expected)))
	if err != nil {
		t.Fatal(err)
	}
	defer container.Delete(ctx, WithSnapshotCleanup)
...
func TestContainerPids(t *testing.T) {
	...
	case "windows":
		if processes[0].Info == nil {
			...
			var details runhcstypes.ProcessDetails
...
func TestContainerCloseIO(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSnapshot(id, image), WithNewSpec(oci.WithImageConfig(image), withCat()))
	if err != nil {
		t.Fatal(err)
	}
	defer container.Delete(ctx, WithSnapshotCleanup)
...
func TestContainerNoBinaryExists(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id,
...
func TestContainerExitedAtSet(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSnapshot(id, image), WithNewSpec(oci.WithImageConfig(image), withTrue()))
	if err != nil {
		t.Fatal(err)
	}
	defer container.Delete(ctx, WithSnapshotCleanup)
...
func TestContainerExtensions(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSpec(), WithContainerExtension("hello", &ext))
	if err != nil {
		t.Fatal(err)
	}
	defer container.Delete(ctx)
...
func TestContainerLabels(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSpec(), WithContainerLabels(map[string]string{
		"test": "yes",
	}))
	if err != nil {
		t.Fatal(err)
...
func TestContainerHook(t *testing.T) {
	...
	container, err := client.newContainerWithOpts(ctx, id, WithNewSnapshot(id, image), WithNewSpec(oci.WithImageConfig(image), hook))
	if err != nil {
		t.Fatal(err)
	}
	defer container.Delete(ctx, WithSnapshotCleanup)
