...
type StateResponse struct {
	...
	ExitReason task.ExitReason        `protobuf:"varint,12,opt,name=exit_reason,json=exitReason,proto3,enum=containerd.v1.types.ExitReason" json:"exit_reason,omitempty"`
}
...
func (x *StateResponse) GetExitReason() task.ExitReason {
	if x != nil {
		return x.ExitReason
	}
...
var file_github_com_containerd_containerd_api_runtime_task_v3_shim_proto_rawDesc = []byte{
	...
	0x06, 0x65, 0x78, 0x65, 0x63, 0x49, 0x64, 0x22, 0x95, 0x03, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x74,
	...
	0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x65, 0x78, 0x65, 0x63, 0x49, 0x64, 0x12, 0x40, 0x0a,
	0x0b, 0x65, 0x78, 0x69, 0x74, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64, 0x2e,
	0x76, 0x31, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x45, 0x78, 0x69, 0x74, 0x52, 0x65, 0x61,
	0x73, 0x6f, 0x6e, 0x52, 0x0a, 0x65, 0x78, 0x69, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22,
...
var file_github_com_containerd_containerd_api_runtime_task_v3_shim_proto_goTypes = []interface{}{
	...
	(task.ExitReason)(0),          // 31: containerd.v1.types.ExitReason
...
var file_github_com_containerd_containerd_api_runtime_task_v3_shim_proto_depIdxs = []int32{
	...
	31, // 6: containerd.task.v3.StateResponse.exit_reason:type_name -> containerd.v1.types.ExitReason
	32, // 7: containerd.task.v3.PidsResponse.processes:type_name -> containerd.v1.types.ProcessInfo
	28, // 8: containerd.task.v3.CheckpointTaskRequest.options:type_name -> google.protobuf.Any
	28, // 9: containerd.task.v3.UpdateTaskRequest.resources:type_name -> google.protobuf.Any
	26, // 10: containerd.task.v3.UpdateTaskRequest.annotations:type_name -> containerd.task.v3.UpdateTaskRequest.AnnotationsEntry
	29, // 11: containerd.task.v3.WaitResponse.exited_at:type_name -> google.protobuf.Timestamp
	28, // 12: containerd.task.v3.StatsResponse.stats:type_name -> google.protobuf.Any
	7,  // 13: containerd.task.v3.Task.State:input_type -> containerd.task.v3.StateRequest
	0,  // 14: containerd.task.v3.Task.Create:input_type -> containerd.task.v3.CreateTaskRequest
	15, // 15: containerd.task.v3.Task.Start:input_type -> containerd.task.v3.StartRequest
	2,  // 16: containerd.task.v3.Task.Delete:input_type -> containerd.task.v3.DeleteRequest
	11, // 17: containerd.task.v3.Task.Pids:input_type -> containerd.task.v3.PidsRequest
	24, // 18: containerd.task.v3.Task.Pause:input_type -> containerd.task.v3.PauseRequest
	25, // 19: containerd.task.v3.Task.Resume:input_type -> containerd.task.v3.ResumeRequest
	13, // 20: containerd.task.v3.Task.Checkpoint:input_type -> containerd.task.v3.CheckpointTaskRequest
	9,  // 21: containerd.task.v3.Task.Kill:input_type -> containerd.task.v3.KillRequest
	4,  // 22: containerd.task.v3.Task.Exec:input_type -> containerd.task.v3.ExecProcessRequest
	6,  // 23: containerd.task.v3.Task.ResizePty:input_type -> containerd.task.v3.ResizePtyRequest
	10, // 24: containerd.task.v3.Task.CloseIO:input_type -> containerd.task.v3.CloseIORequest
	14, // 25: containerd.task.v3.Task.Update:input_type -> containerd.task.v3.UpdateTaskRequest
	17, // 26: containerd.task.v3.Task.Wait:input_type -> containerd.task.v3.WaitRequest
	19, // 27: containerd.task.v3.Task.Stats:input_type -> containerd.task.v3.StatsRequest
	21, // 28: containerd.task.v3.Task.Connect:input_type -> containerd.task.v3.ConnectRequest
	23, // 29: containerd.task.v3.Task.Shutdown:input_type -> containerd.task.v3.ShutdownRequest
