...
const file_github_com_containerd_containerd_api_events_snapshot_proto_rawDesc = "" +
	"\n" +
	":github.com/containerd/containerd/api/events/snapshot.proto\x12\x11containerd.events\x1a:github.com/containerd/containerd/api/types/fieldpath.proto\"]\n" +
	"\x0fSnapshotPrepare\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x16\n" +
	"\x06parent\x18\x02 \x01(\tR\x06parent\x12 \n" +
	"\vsnapshotter\x18\x05 \x01(\tR\vsnapshotter\"X\n" +
	"\x0eSnapshotCommit\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vsnapshotter\x18\x05 \x01(\tR\vsnapshotter\"D\n" +
	"\x0eSnapshotRemove\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12 \n" +
	"\vsnapshotter\x18\x05 \x01(\tR\vsnapshotterB8\xa0\xf4\x1e\x01Z2github.com/containerd/containerd/api/events;eventsb\x06proto3"

var (
	file_github_com_containerd_containerd_api_events_snapshot_proto_rawDescOnce sync.Once
	file_github_com_containerd_containerd_api_events_snapshot_proto_rawDescData []byte
)
...
func file_github_com_containerd_containerd_api_events_snapshot_proto_rawDescGZIP() []byte {
	file_github_com_containerd_containerd_api_events_snapshot_proto_rawDescOnce.Do(func() {
		file_github_com_containerd_containerd_api_events_snapshot_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_containerd_containerd_api_events_snapshot_proto_rawDesc), len(file_github_com_containerd_containerd_api_events_snapshot_proto_rawDesc)))
	})
...
var file_github_com_containerd_containerd_api_events_snapshot_proto_goTypes = []any{
...
func file_github_com_containerd_containerd_api_events_snapshot_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_containerd_containerd_api_events_snapshot_proto_rawDesc), len(file_github_com_containerd_containerd_api_events_snapshot_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
