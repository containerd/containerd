...
func (x *SandboxStart) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *SandboxStop) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SandboxStop) ProtoMessage() {}

func (x *SandboxStop) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_containerd_containerd_api_events_sandbox_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SandboxStop.ProtoReflect.Descriptor instead.
...
func (x *SandboxStop) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
var file_github_com_containerd_containerd_api_events_sandbox_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x1e,
	0x0a, 0x0c, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x1d,
	0x0a, 0x0b, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x53, 0x74, 0x6f, 0x70, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x34, 0x5a,
...
var file_github_com_containerd_containerd_api_events_sandbox_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_github_com_containerd_containerd_api_events_sandbox_proto_goTypes = []interface{}{
	(*SandboxStart)(nil), // 0: containerd.events.SandboxStart
	(*SandboxStop)(nil),  // 1: containerd.events.SandboxStop
}
