...
type TaskStart struct {
	...
	ShimPid     uint32 `protobuf:"varint,3,opt,name=shim_pid,json=shimPid,proto3" json:"shim_pid,omitempty"`
}
...
func (x *TaskStart) GetShimPid() uint32 {
	if x != nil {
		return x.ShimPid
	}
	return 0
...
var file_github_com_containerd_containerd_api_events_task_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x70, 0x69, 0x64, 0x22, 0x5b,
	...
	0x12, 0x19, 0x0a, 0x08, 0x73, 0x68, 0x69, 0x6d, 0x5f, 0x70, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x07, 0x73, 0x68, 0x69, 0x6d, 0x50, 0x69, 0x64, 0x22, 0xab, 0x01, 0x0a, 0x0a,
