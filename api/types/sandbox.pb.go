...
type Sandbox struct {
	...
	Extensions map[string]*any1.Any `protobuf:"bytes,7,rep,name=extensions,proto3" json:"extensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Sandbox) GetSpec() *any1.Any {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *Sandbox) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Sandbox) GetUpdatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *Sandbox) GetExtensions() map[string]*any1.Any {
	if x != nil {
		return x.Extensions
	}
	return nil
...
func (x *Sandbox_Runtime) GetOptions() *any1.Any {
	if x != nil {
		return x.Options
	}
	return nil
...
var file_github_com_containerd_containerd_api_types_sandbox_proto_rawDesc = []byte{
	...
	0x04, 0x0a, 0x07, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x61,
	...
	0x70, 0x65, 0x73, 0x58, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
