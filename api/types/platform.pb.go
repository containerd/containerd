...
func (x *Platform) Reset() {
	*x = Platform{}
	if protoimpl.UnsafeEnabled {
		mi := &file_types_platform_proto_msgTypes[0]
...
func (*Platform) Descriptor() ([]byte, []int) {
	return file_types_platform_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_types_platform_proto_rawDescOnce sync.Once
	file_types_platform_proto_rawDescData = file_types_platform_proto_rawDesc
)

func file_types_platform_proto_rawDescGZIP() []byte {
	file_types_platform_proto_rawDescOnce.Do(func() {
		file_types_platform_proto_rawDescData = protoimpl.X.CompressGZIP(file_types_platform_proto_rawDescData)
	})
	return file_types_platform_proto_rawDescData
}

var file_types_platform_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_types_platform_proto_goTypes = []interface{}{
	(*Platform)(nil), // 0: containerd.types.Platform
}
var file_types_platform_proto_depIdxs = []int32{
...
func init() { file_types_platform_proto_init() }
func file_types_platform_proto_init() {
	if File_types_platform_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_types_platform_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_types_platform_proto_goTypes,
		DependencyIndexes: file_types_platform_proto_depIdxs,
		MessageInfos:      file_types_platform_proto_msgTypes,
	}.Build()
	File_types_platform_proto = out.File
	file_types_platform_proto_rawDesc = nil
	file_types_platform_proto_goTypes = nil
	file_types_platform_proto_depIdxs = nil
}
