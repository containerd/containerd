...
type Mount struct {
	...
	MetaDatas            []string `protobuf:"bytes,5,rep,name=meta_datas,json=metaDatas,proto3" json:"meta_datas,omitempty"`
...
var fileDescriptor_920196890d4a7b9f = []byte{
	...
	0x44, 0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0x92, 0xfa, 0x20, 0x16, 0x44, 0x9d, 0x52, 0x0b, 0x23, 0x17,
	...
	0x33, 0x08, 0xc6, 0x15, 0x92, 0xe5, 0xe2, 0xca, 0x4d, 0x2d, 0x49, 0x8c, 0x4f, 0x49, 0x2c, 0x49,
	0x2c, 0x96, 0x60, 0x05, 0x4b, 0x72, 0x82, 0x44, 0x5c, 0x40, 0x02, 0x4e, 0x5e, 0x27, 0x1e, 0xca,
	0x31, 0xdc, 0x78, 0x28, 0xc7, 0xd0, 0xf0, 0x48, 0x8e, 0xf1, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f,
	0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x8c, 0x32, 0x20, 0x3e, 0x00, 0xac, 0xc1, 0x64, 0x12, 0x1b,
	0xd8, 0x67, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xdb, 0x84, 0x5a, 0xda, 0x3b, 0x01, 0x00,
	0x00,
}
...
func (m *Mount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MetaDatas) > 0 {
		for iNdEx := len(m.MetaDatas) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.MetaDatas[iNdEx])
			copy(dAtA[i:], m.MetaDatas[iNdEx])
			i = encodeVarintMount(dAtA, i, uint64(len(m.MetaDatas[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (this *Mount) String() string {
	...
	s := strings.Join([]string{`&Mount{`,
		...
		`MetaDatas:` + fmt.Sprintf("%v", this.MetaDatas) + `,`,
...
func (m *Mount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.MetaDatas = append(m.MetaDatas, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
