...
// needed and if a client needs specific content to be preserved, it should request the
// server to retain all content.
...
const (
	...
	// Needed is the default and will only fetch and retain metadata and content which is
	// needed by the server for the supported platforms.
	ContentRetention_Needed ContentRetention = 1
	// All will fetch and retain all metadata and content for an image to
	// allow fully exporting the original image.
...
var file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x0a, 0x04, 0x4e, 0x6f, 0x6e, 0x65, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x4e, 0x65,
	0x65, 0x64, 0x65, 0x64, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x6c, 0x6c, 0x10, 0x02, 0x42,
