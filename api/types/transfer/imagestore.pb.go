...
// ContentRetention is used to determine how content related the the image should be
// retained. It is up the server implementation to decide what content is considered
// needed to be cached and if a client needs specific content to be preserved, it
// should request the server to retain all content.
type ContentRetention int32

const (
	// None will discard all non-metadata content when it is no longer
	// needed by the server.
	ContentRetention_None ContentRetention = 0
	// Cached is the default and will retain all metadata and content which is
	// fetched by the server for the supported platforms.
	ContentRetention_Cached ContentRetention = 1
	// All will fetch and retain all metadata and content for an image to allow
	// fully exporting the original image, regardless of supported platforms.
	ContentRetention_All ContentRetention = 2
)

// Enum value maps for ContentRetention.
var (
	ContentRetention_name = map[int32]string{
		0: "None",
		1: "Cached",
		2: "All",
	}
	ContentRetention_value = map[string]int32{
		"None":   0,
		"Cached": 1,
		"All":    2,
	}
...
func (x ContentRetention) Enum() *ContentRetention {
	p := new(ContentRetention)
	*p = x
	return p
}

func (x ContentRetention) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ContentRetention) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_enumTypes[0].Descriptor()
}

func (ContentRetention) Type() protoreflect.EnumType {
	return &file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_enumTypes[0]
}

func (x ContentRetention) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ContentRetention.Descriptor instead.
func (ContentRetention) EnumDescriptor() ([]byte, []int) {
...
type ImageStore struct {
	...
	ContentRetention ContentRetention       `protobuf:"varint,15,opt,name=content_retention,json=contentRetention,proto3,enum=containerd.types.transfer.ContentRetention" json:"content_retention,omitempty"`
}
...
func (x *ImageStore) GetContentRetention() ContentRetention {
	if x != nil {
		return x.ContentRetention
	}
	return ContentRetention_None
}
...
var file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x04, 0x0a,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x75, 0x6e, 0x70, 0x61, 0x63, 0x6b, 0x73, 0x12, 0x58,
	0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x74, 0x65, 0x6e, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x64, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x74, 0x72, 0x61,
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x74,
	0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x10, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52,
	0x65, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x39, 0x0a, 0x0b, 0x4c, 0x61, 0x62, 0x65,
	...
	0x74, 0x74, 0x65, 0x72, 0x22, 0xb5, 0x01, 0x0a, 0x0e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x65,
	...
	0x73, 0x5f, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08,
	0x69, 0x73, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x27, 0x0a, 0x0f, 0x61, 0x6c, 0x6c, 0x6f,
	...
	,
...
var file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_goTypes = []interface{}{
	(ContentRetention)(0),       // 0: containerd.types.transfer.ContentRetention
	(*ImageStore)(nil),          // 1: containerd.types.transfer.ImageStore
	(*UnpackConfiguration)(nil), // 2: containerd.types.transfer.UnpackConfiguration
	(*ImageReference)(nil),      // 3: containerd.types.transfer.ImageReference
	nil,                         // 4: containerd.types.transfer.ImageStore.LabelsEntry
...
var file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_depIdxs = []int32{
	4, // 0: containerd.types.transfer.ImageStore.labels:type_name -> containerd.types.transfer.ImageStore.LabelsEntry
	5, // 1: containerd.types.transfer.ImageStore.platforms:type_name -> containerd.types.Platform
	3, // 2: containerd.types.transfer.ImageStore.extra_references:type_name -> containerd.types.transfer.ImageReference
	2, // 3: containerd.types.transfer.ImageStore.unpacks:type_name -> containerd.types.transfer.UnpackConfiguration
	0, // 4: containerd.types.transfer.ImageStore.content_retention:type_name -> containerd.types.transfer.ContentRetention
	5, // 5: containerd.types.transfer.UnpackConfiguration.platform:type_name -> containerd.types.Platform
...
func file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_enumTypes,
