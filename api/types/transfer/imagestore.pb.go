...
const file_github_com_containerd_containerd_api_types_transfer_imagestore_proto_rawDesc = "" +
	"\n" +
	"Dgithub.com/containerd/containerd/api/types/transfer/imagestore.proto\x12\x19containerd.types.transfer\x1a9github.com/containerd/containerd/api/types/platform.proto\"\xca\x03\n" +
	"\n" +
	"ImageStore\x12\x12\n" +
	...
	"\aunpacks\x18\n" +
	" \x03(\v2..containerd.types.transfer.UnpackConfigurationR\aunpacks\x1a9\n" +
