...
type RegistryResolver struct {
	...
	HttpDebug bool `protobuf:"varint,5,opt,name=http_debug,json=httpDebug,proto3" json:"http_debug,omitempty"`
	// Enable HTTP requests tracing
	HttpTrace bool `protobuf:"varint,6,opt,name=http_trace,json=httpTrace,proto3" json:"http_trace,omitempty"`
}
...
func (x *RegistryResolver) GetHttpDebug() bool {
	if x != nil {
		return x.HttpDebug
	}
	return false
...
func (x *RegistryResolver) GetHttpTrace() bool {
	if x != nil {
		return x.HttpTrace
	}
	return false
...
var file_github_com_containerd_containerd_api_types_transfer_registry_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x6c, 0x76, 0x65, 0x72, 0x22, 0xc3, 0x02, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x64, 0x65, 0x62, 0x75, 0x67,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x68, 0x74, 0x74, 0x70, 0x44, 0x65, 0x62, 0x75,
	0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x68, 0x74, 0x74, 0x70, 0x54, 0x72, 0x61, 0x63, 0x65,
