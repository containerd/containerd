...
func (Status) Descriptor() protoreflect.EnumDescriptor {
	return file_containerd_types_task_task_proto_enumTypes[0].Descriptor()
}

func (Status) Type() protoreflect.EnumType {
	return &file_containerd_types_task_task_proto_enumTypes[0]
}
...
func (Status) EnumDescriptor() ([]byte, []int) {
	return file_containerd_types_task_task_proto_rawDescGZIP(), []int{0}
}
...
func (x *Process) Reset() {
	*x = Process{}
	if protoimpl.UnsafeEnabled {
		mi := &file_containerd_types_task_task_proto_msgTypes[0]
...
func (x *ProcessInfo) Reset() {
	*x = ProcessInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_containerd_types_task_task_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProcessInfo) Descriptor() ([]byte, []int) {
	return file_containerd_types_task_task_proto_rawDescGZIP(), []int{1}
}
...
var File_containerd_types_task_task_proto protoreflect.FileDescriptor

var file_containerd_types_task_task_proto_rawDesc = []byte{
	0x0a, 0x20, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64, 0x2f, 0x74, 0x79, 0x70,
	...
	0x31, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f,
...
var (
	file_containerd_types_task_task_proto_rawDescOnce sync.Once
	file_containerd_types_task_task_proto_rawDescData = file_containerd_types_task_task_proto_rawDesc
)

func file_containerd_types_task_task_proto_rawDescGZIP() []byte {
	file_containerd_types_task_task_proto_rawDescOnce.Do(func() {
		file_containerd_types_task_task_proto_rawDescData = protoimpl.X.CompressGZIP(file_containerd_types_task_task_proto_rawDescData)
	})
	return file_containerd_types_task_task_proto_rawDescData
}

var file_containerd_types_task_task_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_containerd_types_task_task_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_containerd_types_task_task_proto_goTypes = []interface{}{
...
var file_containerd_types_task_task_proto_depIdxs = []int32{
...
func init() { file_containerd_types_task_task_proto_init() }
func file_containerd_types_task_task_proto_init() {
	if File_containerd_types_task_task_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_containerd_types_task_task_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_containerd_types_task_task_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_containerd_types_task_task_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_containerd_types_task_task_proto_goTypes,
		DependencyIndexes: file_containerd_types_task_task_proto_depIdxs,
		EnumInfos:         file_containerd_types_task_task_proto_enumTypes,
		MessageInfos:      file_containerd_types_task_task_proto_msgTypes,
	}.Build()
	File_containerd_types_task_task_proto = out.File
	file_containerd_types_task_task_proto_rawDesc = nil
	file_containerd_types_task_task_proto_goTypes = nil
	file_containerd_types_task_task_proto_depIdxs = nil
}
