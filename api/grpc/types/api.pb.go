...
type Timeval struct {
	...
	Usec uint64 `protobuf:"varint,2,opt,name=usec" json:"usec,omitempty"`
}

func (m *Timeval) Reset()                    { *m = Timeval{} }
func (m *Timeval) String() string            { return proto.CompactTextString(m) }
func (*Timeval) ProtoMessage()               {}
func (*Timeval) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{44} }

func (m *Timeval) GetSec() uint64 {
	if m != nil {
		return m.Sec
	}
	return 0
...
type UsageStats struct {
	Utime    *Timeval `protobuf:"bytes,1,opt,name=utime" json:"utime,omitempty"`
	Stime    *Timeval `protobuf:"bytes,2,opt,name=stime" json:"stime,omitempty"`
	Maxrss   uint64   `protobuf:"varint,3,opt,name=maxrss" json:"maxrss,omitempty"`
	Ixrss    uint64   `protobuf:"varint,4,opt,name=ixrss" json:"ixrss,omitempty"`
	Idrss    uint64   `protobuf:"varint,5,opt,name=idrss" json:"idrss,omitempty"`
	Isrss    uint64   `protobuf:"varint,6,opt,name=isrss" json:"isrss,omitempty"`
	Minflt   uint64   `protobuf:"varint,7,opt,name=minflt" json:"minflt,omitempty"`
	Majflt   uint64   `protobuf:"varint,8,opt,name=majflt" json:"majflt,omitempty"`
	Nswap    uint64   `protobuf:"varint,9,opt,name=nswap" json:"nswap,omitempty"`
	Inblock  uint64   `protobuf:"varint,10,opt,name=inblock" json:"inblock,omitempty"`
	Oublock  uint64   `protobuf:"varint,11,opt,name=oublock" json:"oublock,omitempty"`
	Msgsnd   uint64   `protobuf:"varint,12,opt,name=msgsnd" json:"msgsnd,omitempty"`
	Msgrcv   uint64   `protobuf:"varint,13,opt,name=msgrcv" json:"msgrcv,omitempty"`
	Nsignals uint64   `protobuf:"varint,14,opt,name=nsignals" json:"nsignals,omitempty"`
	Nvcsw    uint64   `protobuf:"varint,15,opt,name=nvcsw" json:"nvcsw,omitempty"`
	Nivcsw   uint64   `protobuf:"varint,16,opt,name=nivcsw" json:"nivcsw,omitempty"`
}
...
func (*UsageStats) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{45} }

func (m *UsageStats) GetUtime() *Timeval {
	if m != nil {
		return m.Utime
	}
	return nil
...
func (m *UsageStats) GetStime() *Timeval {
	if m != nil {
		return m.Stime
	}
	return nil
...
func (m *UsageStats) GetMaxrss() uint64 {
	if m != nil {
		return m.Maxrss
	}
	return 0
...
func (m *UsageStats) GetIxrss() uint64 {
	if m != nil {
		return m.Ixrss
	}
	return 0
...
func (m *UsageStats) GetIdrss() uint64 {
	if m != nil {
		return m.Idrss
	}
	return 0
...
func (m *UsageStats) GetIsrss() uint64 {
	if m != nil {
		return m.Isrss
	}
	return 0
...
func (m *UsageStats) GetMinflt() uint64 {
	if m != nil {
		return m.Minflt
	}
	return 0
...
func (m *UsageStats) GetMajflt() uint64 {
	if m != nil {
		return m.Majflt
	}
	return 0
...
func (m *UsageStats) GetNswap() uint64 {
	if m != nil {
		return m.Nswap
	}
	return 0
...
func (m *UsageStats) GetInblock() uint64 {
	if m != nil {
		return m.Inblock
	}
	return 0
...
func (m *UsageStats) GetOublock() uint64 {
	if m != nil {
		return m.Oublock
	}
	return 0
...
func (m *UsageStats) GetMsgsnd() uint64 {
	if m != nil {
		return m.Msgsnd
	}
	return 0
...
func (m *UsageStats) GetMsgrcv() uint64 {
	if m != nil {
		return m.Msgrcv
	}
	return 0
...
func (m *UsageStats) GetNsignals() uint64 {
	if m != nil {
		return m.Nsignals
	}
	return 0
...
func (m *UsageStats) GetNvcsw() uint64 {
	if m != nil {
		return m.Nvcsw
	}
	return 0
...
func (m *UsageStats) GetNivcsw() uint64 {
	if m != nil {
		return m.Nivcsw
	}
	return 0
...
type PostMortemResponse struct {
	Stats *UsageStats `protobuf:"bytes,1,opt,name=stats" json:"stats,omitempty"`
}
...
func (*PostMortemResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{46} }

func (m *PostMortemResponse) GetStats() *UsageStats {
	if m != nil {
		return m.Stats
	}
	return nil
...
func (m *PostMortemRequest) Reset()                    { *m = PostMortemRequest{} }
func (m *PostMortemRequest) String() string            { return proto.CompactTextString(m) }
func (*PostMortemRequest) ProtoMessage()               {}
func (*PostMortemRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }

func (m *PostMortemRequest) GetContainerid() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Timeval)(nil), "types.Timeval")
	proto.RegisterType((*UsageStats)(nil), "types.UsageStats")
	proto.RegisterType((*PostMortemResponse)(nil), "types.PostMortemResponse")
	proto.RegisterType((*StatsResponse)(nil), "types.StatsResponse")
	proto.RegisterType((*StatsRequest)(nil), "types.StatsRequest")
	proto.RegisterType((*PostMortemRequest)(nil), "types.PostMortemRequest")
}
...
type APIClient interface {
	...
	PostMortemStats(ctx context.Context, in *PostMortemRequest, opts ...grpc.CallOption) (*PostMortemResponse, error)
}
...
func (c *aPIClient) PostMortemStats(ctx context.Context, in *PostMortemRequest, opts ...grpc.CallOption) (*PostMortemResponse, error) {
	out := new(PostMortemResponse)
	err := grpc.Invoke(ctx, "/types.API/PostMortemStats", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServer interface {
	...
	PostMortemStats(context.Context, *PostMortemRequest) (*PostMortemResponse, error)
}
...
func _API_PostMortemStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostMortemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).PostMortemStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.API/PostMortemStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).PostMortemStats(ctx, req.(*PostMortemRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PostMortemStats",
			Handler:    _API_PostMortemStats_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
