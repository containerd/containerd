...
func (*GetLogRequest) Descriptor() ([]byte, []int) { return fileDescriptorShim, []int{17} }
...
func (*GetLogResponse) Descriptor() ([]byte, []int) { return fileDescriptorShim, []int{18} }
...
func init() {
	...
	proto.RegisterType((*GetLogRequest)(nil), "containerd.shim.v1.GetLogRequest")
	proto.RegisterType((*GetLogResponse)(nil), "containerd.shim.v1.GetLogResponse")
...
func (this *GetLogRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&shim.GetLogRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetLogResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&shim.GetLogResponse{")
...
func (c *shimClient) GetLog(ctx context.Context, in *GetLogRequest, opts ...grpc.CallOption) (*GetLogResponse, error) {
	out := new(GetLogResponse)
	err := grpc.Invoke(ctx, "/containerd.shim.v1.Shim/GetLog", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Shim_GetLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShimServer).GetLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/containerd.shim.v1.Shim/GetLog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShimServer).GetLog(ctx, req.(*GetLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *GetLogResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetLogResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Log) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintShim(dAtA, i, uint64(len(m.Log)))
		i += copy(dAtA[i:], m.Log)
	}
	return i, nil
}
...
func (m *GetLogResponse) Size() (n int) {
	var l int
	_ = l
	l = len(m.Log)
	if l > 0 {
...
func (this *GetLogRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetLogRequest{`,
		`}`,
	}, "")
	return s
}
func (this *GetLogResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&GetLogResponse{`,
...
func (m *GetLogResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetLogResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetLogResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorShim = []byte{
	...
	,
}
