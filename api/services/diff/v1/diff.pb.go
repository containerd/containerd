...
type ApplyRequest struct {
	...
	Diff   *containerd_types1.Descriptor `protobuf:"bytes,2,opt,name=diff" json:"diff,omitempty"`
	Mounts []*containerd_types.Mount     `protobuf:"bytes,3,rep,name=mounts" json:"mounts,omitempty"`
}
...
type DiffRequest struct {
	...
	Left []*containerd_types.Mount `protobuf:"bytes,2,rep,name=left" json:"left,omitempty"`
	// Right are the mounts which represents the newer copy
	// in which changes from the left were made into.
	Right []*containerd_types.Mount `protobuf:"bytes,3,rep,name=right" json:"right,omitempty"`
...
func (m *ApplyRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Snapshotter) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintDiff(dAtA, i, uint64(len(m.Snapshotter)))
...
var fileDescriptorDiff = []byte{
	...
	,
}
