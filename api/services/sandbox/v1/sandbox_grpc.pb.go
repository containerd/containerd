...
type ControllerClient interface {
	...
	UpdateResource(ctx context.Context, in *ControllerUpdateResourceRequest, opts ...grpc.CallOption) (*ControllerUpdateResourceResponse, error)
}
...
func (c *controllerClient) UpdateResource(ctx context.Context, in *ControllerUpdateResourceRequest, opts ...grpc.CallOption) (*ControllerUpdateResourceResponse, error) {
	out := new(ControllerUpdateResourceResponse)
	err := c.cc.Invoke(ctx, "/containerd.services.sandbox.v1.Controller/UpdateResource", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControllerServer interface {
	...
	UpdateResource(context.Context, *ControllerUpdateResourceRequest) (*ControllerUpdateResourceResponse, error)
...
func (UnimplementedControllerServer) UpdateResource(context.Context, *ControllerUpdateResourceRequest) (*ControllerUpdateResourceResponse, error) {
...
func _Controller_UpdateResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ControllerUpdateResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).UpdateResource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/containerd.services.sandbox.v1.Controller/UpdateResource",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).UpdateResource(ctx, req.(*ControllerUpdateResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Controller_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Controller_UpdateResource_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "github.com/containerd/containerd/api/services/sandbox/v1/sandbox.proto",
