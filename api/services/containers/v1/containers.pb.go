...
type Container struct {
	...
	Spec *any1.Any `protobuf:"bytes,5,opt,name=spec,proto3" json:"spec,omitempty"`
	...
	Extensions map[string]*any1.Any `protobuf:"bytes,10,rep,name=extensions,proto3" json:"extensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *Container) GetSpec() *any1.Any {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *Container) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Container) GetUpdatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func (x *Container) GetExtensions() map[string]*any1.Any {
	if x != nil {
		return x.Extensions
	}
	return nil
...
func (x *UpdateContainerRequest) GetUpdateMask() *field_mask.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
func (x *Container_Runtime) GetOptions() *any1.Any {
	if x != nil {
		return x.Options
	}
	return nil
