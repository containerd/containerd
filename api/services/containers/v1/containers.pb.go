...
type GetContainerRequest struct {
	ID string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// FieldMask specifies which fields to be fetched. If empty,
...
func (m *GetContainerRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FieldMask != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintContainers(dAtA, i, uint64(m.FieldMask.Size()))
...
func (this *GetContainerRequest) String() string {
	...
	s := strings.Join([]string{`&GetContainerRequest{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`FieldMask:` + strings.Replace(fmt.Sprintf("%v", this.FieldMask), "FieldMask", "google_protobuf3.FieldMask", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorContainers = []byte{
	...
	,
}
