...
func (*UnimplementedSnapshotsServer) Annotate(ctx context.Context, req *AnnotateRequest) (*AnnotateResponse, error) {
...
func (m *AnnotateRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AnnotateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
