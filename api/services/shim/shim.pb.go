...
import containerd_v1_types1 "github.com/docker/containerd/api/types/process"
import containerd_v1_types2 "github.com/docker/containerd/api/types/user"
...
type ExecRequest struct {
	...
	User            *containerd_v1_types2.User `protobuf:"bytes,6,opt,name=user" json:"user,omitempty"`
...
type StateResponse struct {
	...
	Processes []*containerd_v1_types1.ProcessState `protobuf:"bytes,4,rep,name=processes" json:"processes,omitempty"`
}
...
func (this *ExecRequest) String() string {
	...
	s := strings.Join([]string{`&ExecRequest{`,
		...
		`User:` + strings.Replace(fmt.Sprintf("%v", this.User), "User", "containerd_v1_types2.User", 1) + `,`,
...
func (this *StateResponse) String() string {
	...
	s := strings.Join([]string{`&StateResponse{`,
		...
		`Processes:` + strings.Replace(fmt.Sprintf("%v", this.Processes), "ProcessState", "containerd_v1_types1.ProcessState", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ExecRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.User == nil {
				m.User = &containerd_v1_types2.User{}
			}
...
func (m *StateResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Processes = append(m.Processes, &containerd_v1_types1.ProcessState{})
...
var fileDescriptorShim = []byte{
	...
	,
}
