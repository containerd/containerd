...
type CreateRequest struct {
	...
	PreserveFds uint32                       `protobuf:"varint,10,opt,name=preserve_fds,json=preserveFds,proto3" json:"preserve_fds,omitempty"`
}
...
func (m *CreateRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PreserveFds != 0 {
		dAtA[i] = 0x50
		i++
		i = encodeVarintShim(dAtA, i, uint64(m.PreserveFds))
	}
	return i, nil
}
...
func (m *CreateRequest) Size() (n int) {
	...
	if m.PreserveFds != 0 {
		n += 1 + sovShim(uint64(m.PreserveFds))
	}
	return n
}
...
func (this *CreateRequest) String() string {
	...
	s := strings.Join([]string{`&CreateRequest{`,
		...
		`PreserveFds:` + fmt.Sprintf("%v", this.PreserveFds) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CreateRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PreserveFds", wireType)
			}
			m.PreserveFds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PreserveFds |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorShim = []byte{
	...
	,
}
