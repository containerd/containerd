...
func withExitStatus(es int) oci.SpecOpts {
	return func(_ context.Context, _ oci.Client, _ *containers.Container, s *specs.Spec) error {
		s.Process.Args = []string{"cmd", "/s", "/c", "exit", strconv.Itoa(es)}
		return nil
	}
}

func withProcessArgs(args ...string) oci.SpecOpts {
	return oci.WithProcessArgs(append([]string{"cmd", "/s", "/c"}, args...)...)
}
...
func withExecExitStatus(s *specs.Process, es int) {
	s.Args = []string{"cmd", "/s", "/c", "exit", strconv.Itoa(es)}
}

func withExecArgs(s *specs.Process, args ...string) {
	s.Args = append([]string{"cmd", "/s", "/c"}, args...)
}
