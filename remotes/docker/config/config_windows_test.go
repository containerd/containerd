...
func TestHostPathsWindows(t *testing.T) {
	...
	// Since technically .io is a country-code, it falls under the second-level hierarchy logic
	...
	expected = []string{"localhost_5555_", "localhost5555", ".localhost_5555_", "_default"}
	...
	expected = []string{"specific.test.localhost_5555_", "specific.test.localhost5555", ".test.localhost_5555_", "_default"}
	...
	// Test w/ second-level hierarchy ccTLD
	expected = []string{"test.docker.co.uk", ".docker.co.uk", "_default"}
	paths = hostPaths("", "test.docker.co.uk")
	compareLists(t, paths, expected)

	// Test w/ second-level hierarchy ccTLD w/ multiple subdomains
	...
	expected = []string{"test.docker.co.uk_5555_", "test.docker.co.uk5555", ".docker.co.uk_5555_", "_default"}
