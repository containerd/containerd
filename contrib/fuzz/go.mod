module github.com/containerd/containerd/contrib/fuzz

replace github.com/containerd/containerd => ../../

replace github.com/containerd/containerd/cmd => ../../cmd
...
require (
	...
	github.com/containerd/containerd/cmd v0.0.0-00010101000000-000000000000
