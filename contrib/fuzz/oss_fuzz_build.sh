...
GOLANG_VERSION=$(cat $SRC/containerd/.go-version)
wget --quiet https://go.dev/dl/go${GOLANG_VERSION}.linux-amd64.tar.gz

mkdir temp-go
rm -rf /root/.go/*
tar -C temp-go/ -xzf go${GOLANG_VERSION}.linux-amd64.tar.gz
