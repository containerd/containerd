...
func IsUncompressedType(mt string) bool {
	...
	case
		...
		ocispec.MediaTypeImageLayerNonDistributable: //nolint:staticcheck
		return true
	default:
		return false
	}
...
func convertMediaType(mt string) string {
	...
	case ocispec.MediaTypeImageLayerNonDistributableGzip, ocispec.MediaTypeImageLayerNonDistributableZstd: //nolint:staticcheck
		return ocispec.MediaTypeImageLayerNonDistributable //nolint:staticcheck
	default:
		return mt
	}
}
