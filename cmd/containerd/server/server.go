...
// UpdateConfig is a function that can modify the configuration after
// migration has been applied
type UpdateConfig func(context.Context, *srvconfig.Config) error

// New creates and initializes a new containerd server
func New(ctx context.Context, config *srvconfig.Config, changes ...UpdateConfig) (*Server, error) {
	var (
	...
	for _, change := range changes {
		if err := change(ctx, config); err != nil {
			return nil, err
		}
	}
