...
func (s *execCreatedState) Status(context.Context) (string, error) {
	return "created", nil
}
...
func (s *execRunningState) Status(context.Context) (string, error) {
	return "running", nil
}
...
func (s *execStoppedState) Status(context.Context) (string, error) {
	return "stopped", nil
}
