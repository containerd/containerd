...
func (p *linuxPlatform) CopyConsole(ctx context.Context, console console.Console, id, stdin, stdout, _ string, wg *sync.WaitGroup) (cons console.Console, retErr error) {
	if p.epoller == nil {
