...
$PACKAGES= @{ mingw = "10.2.0"; git = ""; golang = "1.26.2"; make = ""; nssm = "" }
...
$CRICTL_DOWNLOAD_URL="https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.35.0/crictl-v1.35.0-windows-amd64.tar.gz"
