...
func TestToCRISignal(t *testing.T) {
	tests := []struct {
		...
		{input: "SIGABRT", expected: runtime.Signal_SIGNAL_SIGABRT},
		{input: "SIGALRM", expected: runtime.Signal_SIGNAL_SIGALRM},
		{input: "SIGBUS", expected: runtime.Signal_SIGNAL_SIGBUS},
		{input: "SIGCHLD", expected: runtime.Signal_SIGNAL_SIGCHLD},
		{input: "SIGCLD", expected: runtime.Signal_SIGNAL_SIGCLD},
		{input: "SIGCONT", expected: runtime.Signal_SIGNAL_SIGCONT},
		{input: "SIGFPE", expected: runtime.Signal_SIGNAL_SIGFPE},
		{input: "SIGHUP", expected: runtime.Signal_SIGNAL_SIGHUP},
		{input: "SIGILL", expected: runtime.Signal_SIGNAL_SIGILL},
		{input: "SIGINT", expected: runtime.Signal_SIGNAL_SIGINT},
		{input: "SIGIO", expected: runtime.Signal_SIGNAL_SIGIO},
		{input: "SIGIOT", expected: runtime.Signal_SIGNAL_SIGIOT},
		{input: "SIGKILL", expected: runtime.Signal_SIGNAL_SIGKILL},
		{input: "SIGPIPE", expected: runtime.Signal_SIGNAL_SIGPIPE},
		{input: "SIGPOLL", expected: runtime.Signal_SIGNAL_SIGPOLL},
		{input: "SIGPROF", expected: runtime.Signal_SIGNAL_SIGPROF},
		{input: "SIGPWR", expected: runtime.Signal_SIGNAL_SIGPWR},
		{input: "SIGQUIT", expected: runtime.Signal_SIGNAL_SIGQUIT},
		{input: "SIGSEGV", expected: runtime.Signal_SIGNAL_SIGSEGV},
		{input: "SIGSTKFLT", expected: runtime.Signal_SIGNAL_SIGSTKFLT},
		{input: "SIGSTOP", expected: runtime.Signal_SIGNAL_SIGSTOP},
		{input: "SIGSYS", expected: runtime.Signal_SIGNAL_SIGSYS},
		{input: "SIGTERM", expected: runtime.Signal_SIGNAL_SIGTERM},
		{input: "SIGTRAP", expected: runtime.Signal_SIGNAL_SIGTRAP},
		{input: "SIGTSTP", expected: runtime.Signal_SIGNAL_SIGTSTP},
		{input: "SIGTTIN", expected: runtime.Signal_SIGNAL_SIGTTIN},
		{input: "SIGTTOU", expected: runtime.Signal_SIGNAL_SIGTTOU},
		{input: "SIGURG", expected: runtime.Signal_SIGNAL_SIGURG},
		{input: "SIGUSR1", expected: runtime.Signal_SIGNAL_SIGUSR1},
		{input: "SIGUSR2", expected: runtime.Signal_SIGNAL_SIGUSR2},
		{input: "SIGVTALRM", expected: runtime.Signal_SIGNAL_SIGVTALRM},
		{input: "SIGWINCH", expected: runtime.Signal_SIGNAL_SIGWINCH},
		{input: "SIGXCPU", expected: runtime.Signal_SIGNAL_SIGXCPU},
		{input: "SIGXFSZ", expected: runtime.Signal_SIGNAL_SIGXFSZ},
		{input: "SIGRTMIN", expected: runtime.Signal_SIGNAL_SIGRTMIN},
		{input: "SIGRTMIN+1", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS1},
		{input: "SIGRTMIN+2", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS2},
		{input: "SIGRTMIN+3", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS3},
		{input: "SIGRTMIN+4", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS4},
		{input: "SIGRTMIN+5", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS5},
		{input: "SIGRTMIN+6", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS6},
		{input: "SIGRTMIN+7", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS7},
		{input: "SIGRTMIN+8", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS8},
		{input: "SIGRTMIN+9", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS9},
		{input: "SIGRTMIN+10", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS10},
		{input: "SIGRTMIN+11", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS11},
		{input: "SIGRTMIN+12", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS12},
		{input: "SIGRTMIN+13", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS13},
		{input: "SIGRTMIN+14", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS14},
		{input: "SIGRTMIN+15", expected: runtime.Signal_SIGNAL_SIGRTMINPLUS15},
		{input: "SIGRTMAX-14", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS14},
		{input: "SIGRTMAX-13", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS13},
		{input: "SIGRTMAX-12", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS12},
		{input: "SIGRTMAX-11", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS11},
		{input: "SIGRTMAX-10", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS10},
		{input: "SIGRTMAX-9", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS9},
		{input: "SIGRTMAX-8", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS8},
		{input: "SIGRTMAX-7", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS7},
		{input: "SIGRTMAX-6", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS6},
		{input: "SIGRTMAX-5", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS5},
		{input: "SIGRTMAX-4", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS4},
		{input: "SIGRTMAX-3", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS3},
		{input: "SIGRTMAX-2", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS2},
		{input: "SIGRTMAX-1", expected: runtime.Signal_SIGNAL_SIGRTMAXMINUS1},
		{input: "SIGRTMAX", expected: runtime.Signal_SIGNAL_SIGRTMAX},
		{input: "SIGNOPE", expected: runtime.Signal_SIGNAL_RUNTIME_DEFAULT},
	}
