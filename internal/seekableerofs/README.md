## `internal/seekableerofs`

This package implements the core logic for the seekable EROFS layer format, as defined in https://github.com/containerd/containerd/pull/12703/files (TODO(ac): update this)
...
- Create a seekable erofs image:
  - via ctr: `ctr images convert --to-seekable-erofs`
...
│                     └────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                                      │
│   Note: dmverity.offset points at the dm-verity payload start (8 bytes after the header).            │
│                                                                                                      │
...
| Table header      | Metadata | Hash Algo                 | 1          | 0=None, 1=SHA-256 (default on)               |
| Table header      | Metadata | Hash Size                 | 1          | 32 for SHA-256; 0 if Hash Algo is 0          |
| Table header      | Metadata | Reserved                  | 2          | must be 0                                    |
| Chunk entry       | Data     | Block Offset              | 8          | absolute file offset of chunk zstd frame     |
| Chunk entry       | Data     | Checksum                  | N          | optional; N = Hash Size                      |
| [more entries]    |          |                           |            |                                              |
+===================+==========+===========================+============+==============================================+
...
TODO(ac): is dm-verity superblock data optional or required?
```
