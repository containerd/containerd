...
type KillRequest struct {
	...
	RawSignal            string   `protobuf:"bytes,5,opt,name=raw_signal,json=rawSignal,proto3" json:"raw_signal,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_310e7127b8a26f14 = []byte{
	...
	,
}
...
func (m *KillRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RawSignal) > 0 {
		i -= len(m.RawSignal)
		copy(dAtA[i:], m.RawSignal)
		i = encodeVarintTasks(dAtA, i, uint64(len(m.RawSignal)))
		i--
		dAtA[i] = 0x2a
	}
	if m.All {
...
func (this *KillRequest) String() string {
	...
	s := strings.Join([]string{`&KillRequest{`,
		...
		`RawSignal:` + fmt.Sprintf("%v", this.RawSignal) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
...
func (m *KillRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawSignal", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RawSignal = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTasks(dAtA[iNdEx:])
