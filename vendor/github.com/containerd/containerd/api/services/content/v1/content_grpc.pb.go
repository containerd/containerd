...
const (
	Content_Info_FullMethodName         = "/containerd.services.content.v1.Content/Info"
	Content_Update_FullMethodName       = "/containerd.services.content.v1.Content/Update"
	Content_List_FullMethodName         = "/containerd.services.content.v1.Content/List"
	Content_Delete_FullMethodName       = "/containerd.services.content.v1.Content/Delete"
	Content_Read_FullMethodName         = "/containerd.services.content.v1.Content/Read"
	Content_Status_FullMethodName       = "/containerd.services.content.v1.Content/Status"
	Content_ListStatuses_FullMethodName = "/containerd.services.content.v1.Content/ListStatuses"
	Content_Write_FullMethodName        = "/containerd.services.content.v1.Content/Write"
	Content_Abort_FullMethodName        = "/containerd.services.content.v1.Content/Abort"
)
...
type ContentClient interface {
	...
	// set.
	List(ctx context.Context, in *ListContentRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ListContentResponse], error)
	...
	Read(ctx context.Context, in *ReadContentRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReadContentResponse], error)
	...
	Write(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WriteContentRequest, WriteContentResponse], error)
...
func (c *contentClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Content_Info_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Content_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentClient) List(ctx context.Context, in *ListContentRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ListContentResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Content_ServiceDesc.Streams[0], Content_List_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ListContentRequest, ListContentResponse]{ClientStream: stream}
...
type Content_ListClient = grpc.ServerStreamingClient[ListContentResponse]
...
func (c *contentClient) Read(ctx context.Context, in *ReadContentRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReadContentResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Content_ServiceDesc.Streams[1], Content_Read_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ReadContentRequest, ReadContentResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Content_ReadClient = grpc.ServerStreamingClient[ReadContentResponse]

func (c *contentClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, Content_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentClient) ListStatuses(ctx context.Context, in *ListStatusesRequest, opts ...grpc.CallOption) (*ListStatusesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Content_ListStatuses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *contentClient) Write(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WriteContentRequest, WriteContentResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Content_ServiceDesc.Streams[2], Content_Write_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Content_WriteClient = grpc.BidiStreamingClient[WriteContentRequest, WriteContentResponse]

func (c *contentClient) Abort(ctx context.Context, in *AbortRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Content_Abort_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ContentServer interface {
	...
	// Clients should make provisions to ensure they can handle the entire data
	// set.
	List(*ListContentRequest, grpc.ServerStreamingServer[ListContentResponse]) error
	// Delete will delete the referenced object.
	Delete(context.Context, *DeleteContentRequest) (*emptypb.Empty, error)
	// Read allows one to read an object based on the offset into the content.
	//
	// The requested data may be returned in one or more messages.
	Read(*ReadContentRequest, grpc.ServerStreamingServer[ReadContentResponse]) error
	// Status returns the status for a single reference.
	...
	// When completed, the commit flag should be set to true. If expected size
	// or digest is set, the content will be validated against those values.
	Write(grpc.BidiStreamingServer[WriteContentRequest, WriteContentResponse]) error
	// Abort cancels the ongoing write named in the request. Any resources
	// associated with the write will be collected.
...
func (UnimplementedContentServer) List(*ListContentRequest, grpc.ServerStreamingServer[ListContentResponse]) error {
...
func (UnimplementedContentServer) Read(*ReadContentRequest, grpc.ServerStreamingServer[ReadContentResponse]) error {
...
func (UnimplementedContentServer) Write(grpc.BidiStreamingServer[WriteContentRequest, WriteContentResponse]) error {
...
func _Content_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Content_Info_FullMethodName,
	}
...
func _Content_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Content_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Content_List_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ContentServer).List(m, &grpc.GenericServerStream[ListContentRequest, ListContentResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Content_ListServer = grpc.ServerStreamingServer[ListContentResponse]
...
func _Content_Read_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ContentServer).Read(m, &grpc.GenericServerStream[ReadContentRequest, ReadContentResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Content_ReadServer = grpc.ServerStreamingServer[ReadContentResponse]
...
func _Content_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Content_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Content_ListStatuses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Content_ListStatuses_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Content_Write_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ContentServer).Write(&grpc.GenericServerStream[WriteContentRequest, WriteContentResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Content_WriteServer = grpc.BidiStreamingServer[WriteContentRequest, WriteContentResponse]
...
func _Content_Abort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Content_Abort_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
