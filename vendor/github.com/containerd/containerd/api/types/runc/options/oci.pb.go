...
type CheckpointOptions struct {
	...
	// Should the checkpoint archive include the content of /dev/shm?
	// This is useful for all cases where an external /dev/shm is
	// bind mounted into the container and the content is necessary
	// during restore. This containers the complete path to the location
	// of the containers /dev/shm.
	DevShm string `protobuf:"bytes,10,opt,name=dev_shm,json=devShm,proto3" json:"dev_shm,omitempty"`
}
...
func (x *CheckpointOptions) GetDevShm() string {
	if x != nil {
		return x.DevShm
	}
	return ""
...
var file_github_com_containerd_containerd_api_types_runc_options_oci_proto_rawDesc = []byte{
	...
	0x22, 0xd4, 0x02, 0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x4f,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x77, 0x6f, 0x72, 0x6b, 0x50, 0x61, 0x74, 0x68, 0x12, 0x17,
	0x0a, 0x07, 0x64, 0x65, 0x76, 0x5f, 0x73, 0x68, 0x6d, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x64, 0x65, 0x76, 0x53, 0x68, 0x6d, 0x22, 0x29, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x63, 0x65,
	0x73, 0x73, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x65, 0x78, 0x65,
	0x63, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x65, 0x78, 0x65, 0x63,
	0x49, 0x64, 0x42, 0x41, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
