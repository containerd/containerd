...
const (
	...
	ExitReason_OOMKILLED ExitReason = 1
	ExitReason_SIGNALED  ExitReason = 2
)
...
func (ExitReason) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_containerd_containerd_api_types_task_task_proto_enumTypes[1].Descriptor()
}

func (ExitReason) Type() protoreflect.EnumType {
	return &file_github_com_containerd_containerd_api_types_task_task_proto_enumTypes[1]
}
...
type Process struct {
	...
	ExitReason  ExitReason             `protobuf:"varint,11,opt,name=exit_reason,json=exitReason,proto3,enum=containerd.v1.types.ExitReason" json:"exit_reason,omitempty"`
}
...
func (x *Process) GetExitReason() ExitReason {
	if x != nil {
		return x.ExitReason
	}
...
var file_github_com_containerd_containerd_api_types_task_task_proto_rawDesc = []byte{
	...
	0x62, 0x75, 0x66, 0x2f, 0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x03,
	...
	0x40, 0x0a, 0x0b, 0x65, 0x78, 0x69, 0x74, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	0x64, 0x2e, 0x76, 0x31, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x45, 0x78, 0x69, 0x74, 0x52,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x52, 0x0a, 0x65, 0x78, 0x69, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f,
	0x6e, 0x22, 0x49, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x2a, 0x55, 0x0a, 0x06,
	...
	0x47, 0x10, 0x05, 0x2a, 0x33, 0x0a, 0x0a, 0x45, 0x78, 0x69, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f,
	0x6e, 0x12, 0x08, 0x0a, 0x04, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x4f,
	0x4f, 0x4d, 0x4b, 0x49, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x53, 0x49,
	0x47, 0x4e, 0x41, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68,
	...
	0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_github_com_containerd_containerd_api_types_task_task_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_github_com_containerd_containerd_api_types_task_task_proto_goTypes = []interface{}{
	...
	(ExitReason)(0),               // 1: containerd.v1.types.ExitReason
	(*Process)(nil),               // 2: containerd.v1.types.Process
	(*ProcessInfo)(nil),           // 3: containerd.v1.types.ProcessInfo
...
var file_github_com_containerd_containerd_api_types_task_task_proto_depIdxs = []int32{
	...
	4, // 1: containerd.v1.types.Process.exited_at:type_name -> google.protobuf.Timestamp
	1, // 2: containerd.v1.types.Process.exit_reason:type_name -> containerd.v1.types.ExitReason
	5, // 3: containerd.v1.types.ProcessInfo.info:type_name -> google.protobuf.Any
