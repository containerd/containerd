...
func (r *result) updatePostSetupNetworkRequest(req *PostSetupNetworkRequest) {
	if r.reply.result != nil {
		req.Result = r.reply.result
	}
}
...
func (r *result) adjustPostSetupNetwork(result []*Result, plugin string) error {
	if len(result) > 0 {
