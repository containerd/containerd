...
func createContainerBaseLayerVHDs(ctx context.Context, layerPath string) (err error) {
	...
	createParams := &vhd.CreateVirtualDiskParameters{
		...
		Version2: vhd.CreateVersion2{
			...
			BlockSizeInBytes: computestorage.DefaultVHDXBlockSizeInMB * memory.MiB,
		},
	}
	...
	// for a container.
	if err = vhd.CreateDiffVhd(diffVhdPath, baseVhdPath, computestorage.DefaultVHDXBlockSizeInMB); err != nil {
