...
type Container interface {
	...
	Info(context.Context, ...InfoContainerOpts) (containers.Container, error)
...
func (c *container) Info(ctx context.Context, infoOpt ...InfoContainerOpts) (containers.Container, error) {
	for _, o := range infoOpt {
		if err := o(c); err != nil {
