...
func (c *Client) Pull(ctx context.Context, ref string, opts ...RemoteOpt) (_ Image, retErr error) {
	...
	span.SetAttributes(
		...
		tracing.Attribute("max.concurrent.fetch.chunks.size.mb", pullCtx.ConcurrentFetchChunksSizeMB),
...
func (c *Client) fetch(ctx context.Context, rCtx *RemoteContext, ref string, limit int) (images.Image, error) {
	...
	if rCtx.ConcurrentFetchChunksSizeMB > 0 {
		opts = append(opts, remotes.WithConcurrentFetchChunksSizeMB(rCtx.ConcurrentFetchChunksSizeMB))
	}
