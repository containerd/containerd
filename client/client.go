...
// ContainerStream streams containers from the underlying container store.
//
...
func (c *Client) ContainerStream(ctx context.Context, filters ...string) (iter.Seq2[Container, error], error) {
